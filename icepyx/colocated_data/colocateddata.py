...
path.append('/Users/rominapiunno/Documents/GitHub/icepyx/icepyx/core/')
...
class Colocateddata(GenQuery):
	...
	def __init__(self, spatial_extent=None, date_range=None, start_time=None, end_time=None, proj='Default'):
		...
		>>> reg_a = Colocateddata(spatial_extent=reg_a_bbox, date_range=reg_a_dates)
	...
	def __str__(self):
		...
		str = super(Colocateddata, self).__str__()
