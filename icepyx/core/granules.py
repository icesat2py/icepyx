...
class Granules():
    ...
    def place_order(self, CMRparams, reqparams, subsetparams, verbose, 
        ...
        print('Total number of order request:',request_params['page_num'])
        print('Page_size:',request_params['page_size'])
        print('Total number of available granules:',len(self.avail))
        ...
        #DevNote: only write to file after all orders are complete.
        #         Is it better to save every order? What can we do with that?
