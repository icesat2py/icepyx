...
class Visualize:
    ...
    def __init__(
        ...
        if query_obj._sp_extent.extent_type == "bounding_box":
            self.bbox = query_obj._sp_extent.spatial_extent

        else:
            mrc_bound = query_obj._sp_extent.spatial_extent.minimum_rotated_rectangle
